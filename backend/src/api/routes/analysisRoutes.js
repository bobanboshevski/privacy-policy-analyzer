...
router.post('/pdf/ccpa-compliance/pdf-2-json', verifyFirebaseTokenStrict, requestRestrictions.enforceFileOnly, analysisController.analyzePdf2JsonCcpaCompliance);
